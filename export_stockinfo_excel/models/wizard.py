...
class StockReport(models.TransientModel):
    ...
    category = fields.Many2many('product.category',  string='Warehouse')
    ...
    def export_xls(self):
        ...
        return {
            ...
            'data': {'model': 'wizard.stock.history',
                     ...
                     'output_format': 'xlsx',
                     'report_name': 'Export product stock',
                     },
            'report_type': 'xlsx'
        }
    ...
    def get_lines_warehouse(self, send_data, warehouse,supplier_name ):        
        ...
        # Get the view_location_id of the warehouse
        self._cr.execute("""
    ...
    def get_xlsx_report(self, data, response):
        ...
        get_supplier=self.get_supplier(lines)
        ...
        if lines.tracking_wise == 'warehouse_wise':
            for warehouse_name, warehouse_id in zip(*get_warehouse):
                ...
                for each in get_line:
                    ...
                    sheet.merge_range(row_num, col_num + 1, row_num, col_num + 3, each['name'], font_size_8_l)
                    sheet.merge_range(row_num, col_num + 4, row_num, col_num + 5, each['category'], font_size_8_l)
    ...
    def get_warehouse_data(self, data,warehouse_id,supplier):
        ...
        warehouse_data = self.env['wizard.stock.history'].browse(self._context.get('active_ids', []))
    ...
    def get_location_data(self,data, location_id):
        ...
        location_data = self.env['wizard.stock.history'].browse(self._context.get('active_ids', []))
